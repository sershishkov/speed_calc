...
import Description from '../../../components/descriptions/lessons/level_3/decimals/Description';
...
function Decimals() {
  ...
  return (
    <>
      <Head>
        <title>Произведение десятичных дробей</title>
        <meta name='description' content='Произведение десятичных дробей ' />
      </Head>
