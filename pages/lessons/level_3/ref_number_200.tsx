...
import Description from '../../../components/descriptions/lessons/level_3/refNumber200/Description';
...
function RefNumber200() {
  ...
  return (
    <>
      <Head>
        <title>
          Умножение чисел с опорным числом 200 (над и под опорным числом)
        </title>
        <meta
          name='description'
          content='Умножение чисел с опорным числом 200 (над и под опорным числом) '
        />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_3/ref_number_50'
          hrefNext='/lessons/level_3/ref_number_500'
          time={time}
