...
import Description from '../../../components/descriptions/lessons/level_3/refNumber500/Description';
...
function RefNumber500() {
  ...
  return (
    <>
      <Head>
        <title>
          Умножение чисел с опорным числом 500 (над и под опорным числом)
        </title>
        <meta
          name='description'
          content='Умножение чисел с опорным числом 500 (над и под опорным числом) '
        />
      </Head>
