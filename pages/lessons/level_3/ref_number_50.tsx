...
import Description from '../../../components/descriptions/lessons/level_3/refNumber50/Description';
...
function RefNumber50() {
  ...
  return (
    <>
      <Head>
        <title>
          Умножение чисел с опорным числом 50 (над и под опорным числом)
        </title>
        <meta
          name='description'
          content='Умножение чисел с опорным числом 50 (над и под опорным числом) '
        />
      </Head>
