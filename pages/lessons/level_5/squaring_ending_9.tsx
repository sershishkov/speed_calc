...
import Description1 from '../../../components/descriptions/lessons/level_5/squaringEnding9/Description1';

function SquaringEnding9() {
  const [max, set__max] = useState('200');
  const [examplesNumber, set__examplesNumber] = useState('10');
  const [example, set__example] = useState<genExample__SquaringEnding_9>();
  ...
  const nextTask = () => {
    set__example(new genExample__SquaringEnding_9(Number(max)));
  ...
  return (
    <>
      <Head>
        <title>Возведение в квадрат чисел оканчивающихся на 9</title>
        <meta
          name='description'
          content='Возведение в квадрат чисел оканчивающихся на 9 '
        />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_5/squaring_ending_1'
          hrefNext='/lessons/level_6/division_by_single_number'
          time={time}
