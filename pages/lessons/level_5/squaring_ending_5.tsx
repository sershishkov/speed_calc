...
import Description1 from '../../../components/descriptions/lessons/level_5/squaringEnding5/Description1';

function SquaringEnding5() {
  const [max, set__max] = useState('100');
  const [examplesNumber, set__examplesNumber] = useState('10');
  const [example, set__example] = useState<genExample__SquaringEnding_5>();
  ...
  const nextTask = () => {
    set__example(new genExample__SquaringEnding_5(Number(max)));
  ...
  return (
    <>
      <Head>
        <title>Возведение в квадрат чисел оканчивающихся на 5</title>
        <meta
          name='description'
          content='Возведение в квадрат чисел оканчивающихся на 5 '
        />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_4/substruction'
          hrefNext='/lessons/level_5/squaring_close_to_50'
          time={time}
