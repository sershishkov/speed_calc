...
import Description1 from '../../../components/descriptions/lessons/level_5/squaringClose500/Description1';

function SquaringCloseTo500() {
  const refNumber = 500;
  ...
  return (
    <>
      <Head>
        <title>Возведение в квадрат чисел близких к 500</title>
        <meta
          name='description'
          content='Возведение в квадрат чисел близких к 500 '
        />
      </Head>
...
export default SquaringCloseTo500;
