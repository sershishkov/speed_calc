...
function SimpleSubstraction() {
  ...
  return (
    <>
      <Head>
        <title>Простое вычитание</title>
        <meta name='description' content='Простое вычитание чисел' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_1/simple_addition'
          hrefNext='/lessons/level_1/simple_multiplication'
          time={time}
          title='Простое вычитание чисел'
        />
...
export default SimpleSubstraction;
