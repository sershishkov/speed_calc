...
import Description1 from '../../../components/descriptions/lessons/level_2/referenceNumber100Above/Description1.';
import Description2 from '../../../components/descriptions/lessons/level_2/referenceNumber100Above/Description2.';

function RefNumber100Above() {
  ...
  return (
    <>
      <Head>
        <title>Умножение чисел с опорным числом 100 (числа больше 100)</title>
        <meta
          name='description'
          content='Умножение чисел с опорным числом 100 (числа больше 100) '
        />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='//lessons/level_2/ref_number_20'
...
export default RefNumber100Above;
