...
import Description from '../../../components/descriptions/lessons/level_2/referenceNumber100Below/Description.';

function RefNumber100Below() {
  ...
  return (
    <>
      <Head>
        <title>Умножение чисел с опорным числом 100 (числа меньше 100)</title>
        <meta
          name='description'
          content='Умножение чисел с опорным числом 100 (числа меньше 100) '
        />
      </Head>
...
export default RefNumber100Below;
