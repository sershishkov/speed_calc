...
import Description from '../../../components/descriptions/lessons/level_2/referenceNumber20/Description.';
...
function RefNumber20() {
  ...
  return (
    <>
      <Head>
        <title>Умножение чисел с опорным числом 20</title>
        <meta
          name='description'
          content='Умножение чисел с опорным числом 20 '
        />
      </Head>
