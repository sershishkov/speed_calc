...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy11/Description1';
import Description2 from '../../../components/descriptions/lessons/level_7/myltiplyBy11/Description2';
...
function MyltiplyBy11() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 11</title>
        <meta name='description' content='Умножение на 11 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_6/division_by_multipliers'
          hrefNext='/lessons/level_7/myltiply_by_12'
          time={time}
