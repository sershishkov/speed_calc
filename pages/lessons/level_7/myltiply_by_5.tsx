...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy5/Description1';
...
function MyltiplyBy5() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 5</title>
        <meta name='description' content='Умножение на 5 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_7/myltiply_by_7'
          hrefNext='/lessons/level_7/myltiply_by_9'
          time={time}
