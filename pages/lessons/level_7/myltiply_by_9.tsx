...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy9/Description1';
...
function MyltiplyBy9() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 9</title>
        <meta name='description' content='Умножение на 9 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_7/myltiply_by_5'
          hrefNext='/lessons/level_7/myltiply_by_8'
          time={time}
