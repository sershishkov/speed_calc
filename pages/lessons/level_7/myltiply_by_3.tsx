...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy3/Description1';
...
function MyltiplyBy3() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 3</title>
        <meta name='description' content='Умножение на 3 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_7/myltiply_by_4'
          hrefNext='/lessons/level_8/fast_multiplay_two_digit_by_two_digit'
          time={time}
