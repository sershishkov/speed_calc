...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy4/Description1';
...
function MyltiplyBy4() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 4</title>
        <meta name='description' content='Умножение на 4 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_7/myltiply_by_8'
          hrefNext='/lessons/level_7/myltiply_by_3'
          time={time}
