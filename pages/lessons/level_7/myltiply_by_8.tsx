...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy8/Description1';
...
function MyltiplyBy8() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 8</title>
        <meta name='description' content='Умножение на 8 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_7/myltiply_by_9'
          hrefNext='/lessons/level_7/myltiply_by_4'
          time={time}
