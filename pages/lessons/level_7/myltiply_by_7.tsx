...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy7/Description1';
...
function MyltiplyBy7() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 7</title>
        <meta name='description' content='Умножение на 7 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_7/myltiply_by_6'
          hrefNext='/lessons/level_7/myltiply_by_5'
          time={time}
