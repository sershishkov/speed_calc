...
import Description1 from '../../../components/descriptions/lessons/level_7/myltiplyBy12/Description1';
...
function MyltiplyBy12() {
  ...
  return (
    <>
      <Head>
        <title>Умножение на 12</title>
        <meta name='description' content='Умножение на 12 ' />
      </Head>
      <Grid container direction='column'>
        <Header
          hrefPrev='/lessons/level_7/myltiply_by_11'
          hrefNext='/lessons/level_7/myltiply_by_6'
          time={time}
