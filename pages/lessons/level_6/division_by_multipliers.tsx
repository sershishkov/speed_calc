...
import Description1 from '../../../components/descriptions/lessons/level_6/divByMultipliers/Description1';
...
function DivisionByMultipliers() {
  ...
  const [example, set__example] = useState<genExample__DivByMultipliers>();
  ...
  const nextTask = () => {
    const newExample = new genExample__DivByMultipliers(Number(max));
  ...
  return (
    <>
      <Head>
        <title>Деление в столбик по множителям</title>
        <meta name='description' content='Деление в столбик по множителям ' />
      </Head>
...
export default DivisionByMultipliers;
